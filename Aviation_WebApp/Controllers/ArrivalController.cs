...
namespace Aviation_WebApp.Controllers
{
    public class ArrivalController : Controller
    {
        ...
        [HttpPost]
        public IActionResult FlightArrival(FlightViewModel y)
        {
            var client = new HttpClient();
            var schedules = $"https://airlabs.co/api/v9/schedules?arr_iata={y.iata}&api_key=d6be5dd7-cf0b-44f6-a883-3d1b8a475ae2";
